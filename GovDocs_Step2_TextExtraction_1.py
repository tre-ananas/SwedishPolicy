...
csv_file_path = "publication_info_1.csv"  # Update with the correct file path
...
article_link_directory.to_csv('article_link_directory_save_step_2_1.csv', index=False)
